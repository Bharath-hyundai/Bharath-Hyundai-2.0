    ...
    <section className="bg-white px-6 sm:px-10 py-12 relative max-w-[1400px] mx-auto">
      ...
      <div className="mt-6 flex justify-center lg:justify-end lg:pl-4 space-x-3">
        {colors.map((car) => (
          <button
            key={car.name}
            className={`w-6 h-6 rounded-full border-2 transition-transform duration-200 focus:ring focus:ring-gray-300 ${selectedCar.name === car.name ? "border-black scale-110 ring-2 ring-black" : "border-gray-400"
              }`}
